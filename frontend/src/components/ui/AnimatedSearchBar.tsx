  ...
  return (
    <div className={"relative flex items-center justify-center " + className}>
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] pointer-events-none overflow-hidden -inset-[4px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] pointer-events-none overflow-hidden -inset-[3px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] pointer-events-none overflow-hidden -inset-[2px] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] pointer-events-none overflow-hidden -inset-[1px] rounded-xl blur-[0.5px] 
