  ...
  return (
    <div className={"relative flex items-center justify-center " + className}>
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden -inset-[6px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden -inset-[5px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden -inset-[4px] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden -inset-[3px] rounded-xl blur-[0.5px] 
