  ...
  return (
    <div className={"relative flex items-center justify-center " + className}>
      <div id="poda" className="relative flex items-center justify-center group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[628px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[624px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[614px] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[606px] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative group">
          <input
            ...
            type="text"
            name="text"
            className="bg-[#09090B] border-none w-[602px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-gray-400"
          />
          ...
          >
            <div id="filter-icon" className="flex items-center justify-center z-[2] max-h-10 max-w-[38px] h-full w-full [isolation:isolate] overflow-hidden rounded-lg bg-gradient-to-b from-[#161329] via-black to-[#1d1b4b] border border-transparent">
