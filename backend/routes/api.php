...
// ==========================================
Route::middleware(['auth.api', ApiRateLimiter::class])->group(function () {
    // Session state
    ...
    Route::post('/business-managers/{businessManager}/pages', [FacebookPageController::class, 'store']);
    Route::put('/business-managers/{businessManager}/pages/{facebookPage}', [FacebookPageController::class, 'update']);
    Route::delete('/business-managers/{businessManager}/pages/{facebookPage}', [FacebookPageController::class, 'destroy']);
