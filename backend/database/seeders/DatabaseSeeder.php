...
class DatabaseSeeder extends Seeder
{
    private const BM_DATA = [
        [
            ...
            'overdue' => 0.00,
            'ad_accounts' => [
                ['account_id' => 'ACT-001-MAIN', 'name' => 'Titans Media Main', 'status' => 'active', 'spend' => 45000.00, 'impressions' => 2_500_000, 'clicks' => 125_000],
                ['account_id' => 'ACT-002-PMAX', 'name' => 'Titans Performance Max', 'status' => 'active', 'spend' => 32000.00, 'impressions' => 1_800_000, 'clicks' => 98_000],
                ['account_id' => 'ACT-003-BRAND', 'name' => 'Titans Brand Awareness', 'status' => 'active', 'spend' => 18000.00, 'impressions' => 3_200_000, 'clicks' => 45_000],
            ],
            'pages' => [
        ...
        [
            ...
            'overdue' => 3200.00,
            'ad_accounts' => [
                ['account_id' => 'ACT-101-QT', 'name' => 'QT Launch Campaign', 'status' => 'active', 'spend' => 12000.00, 'impressions' => 890_000, 'clicks' => 43_000],
                ['account_id' => 'ACT-102-QTR', 'name' => 'QT Retargeting', 'status' => 'paused', 'spend' => 5000.00, 'impressions' => 340_000, 'clicks' => 21_000],
            ],
            'pages' => [
        ...
        [
            ...
            'overdue' => 0.00,
            'ad_accounts' => [
                ['account_id' => 'ACT-201-FL', 'name' => 'FL Product Launch', 'status' => 'active', 'spend' => 22000.00, 'impressions' => 1_200_000, 'clicks' => 67_000],
                ['account_id' => 'ACT-202-FLG', 'name' => 'FL Lead Gen', 'status' => 'active', 'spend' => 15000.00, 'impressions' => 670_000, 'clicks' => 41_000],
            ],
            'pages' => [
